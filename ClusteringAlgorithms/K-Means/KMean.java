...
public class KMean {
	...
	public static String SCN="94,204,229";
	public static String skipSequence="?";
	public static int K=6;
	public static boolean isRandomInitialize=true;
	public static double PPV=0.0;
	public static double tao=0.1;
	public static String attToConsider="1,2,3,4,5,6,7,8";
	...
	public void createCluster(int k,double tao)
	{
		...
		kMeanUtil.reCalCentroids(kMeanUtil.assignPointsToNearestCentroid(data, initialCentroids),0);
		for(int i=1;i<999999999;i++)
		{
			kMeanUtil.reCalCentroids(kMeanUtil.assignPointsToNearestCentroid(data, currentCentroids),i);
